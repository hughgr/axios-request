...
/******/ 	var parentJsonpFunction = window["webpackJsonpaxios_request"];
/******/ 	window["webpackJsonpaxios_request"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
window.R = _index.normalRequest;

function showData() {
  //    console.log(moment().format('LLLL'));
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 33)).then(function (moment) {
    console.log(moment().format('LLLL'));
  });
}

_index.normalRequest.delete('/self/bitwise.html', { name: 'cc' }).then(function (data, res) {
  console.log(data);
